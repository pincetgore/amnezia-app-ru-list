...
1. Прогоняет **36 тестов** (`pytest`), включая проверки конфигурации, атомарной записи файлов, защиту от дефолтных маршрутов (`0.0.0.0/0`) и unit-тесты ASN/DNS-резолверов с мокированием API.
...
Выполните команду для запуска всех 36 тестов:
...
Для запуска проверок конфигурации и форматирования (14 тестов):
...
├── test_logic.py           # 14 конфигурационных тестов
