...
1. Прогоняет **37 тестов** (`pytest`), включая проверки конфигурации, атомарной записи файлов, защиту от дефолтных маршрутов (`0.0.0.0/0`) и unit-тесты ASN/DNS-резолверов с мокированием API.
...
Выполните команду для запуска всех 37 тестов:

```bash
pytest -v
```

Для запуска проверок конфигурации и форматирования (15 тестов):
