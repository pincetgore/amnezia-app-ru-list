...
- [⚠️ Юридическая информация](#️-юридическая-информация)
...
- [Инструкция по применению](#инструкция-по-применению)
  - [1. Получите актуальный список](#1-получите-актуальный-список)
  - [2. Настройте AmneziaVPN](#2-настройте-amneziavpn)
- [Локальное развертывание](#локальное-развертывание)
  - [Как добавить свой сервис](#как-добавить-свой-сервис)
  - [Как запустить тесты самостоятельно](#как-запустить-тесты-самостоятельно)
