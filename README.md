...
В список по умолчанию включены диапазоны частных сетей (LAN), CGNAT и Multicast (`10.0.0.0/8`, `192.168.0.0/16`, `100.64.0.0/10` и др.). Это гарантирует, что при включенном VPN у вас не пропадет доступ к домашнему роутеру, локальным ресурсам и устройствам умного дома.
