...
### IP и GEO чеккеры
Эта группа адресов используется некоторыми российскими приложениями для определения, не включен ли VPN у пользователя. Поэтому важно, чтобы трафик к этим адресам проходил напрямую, минуя VPN.
